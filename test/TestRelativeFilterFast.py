...
def _reference(gyro_p, gyro_c, vp, vc, stds, R_wp0, R_wc0, normalize, init_std):
    ...
    f = RelativeFilter(
        ...
        normalize_measurements=normalize, init_orientation_std=init_std)
...
class TestFastKernelRefusesUnsupportedConfigurations(unittest.TestCase):
    ...
    def _call(self, n_sensors=2, sensors_shape=None):
        gyro = np.zeros((10, 3))
