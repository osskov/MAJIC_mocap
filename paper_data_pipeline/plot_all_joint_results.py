...
width = 1.5  # Total width allocated for each group of boxplots (per joint)
spacing = 0.5  # Spacing between groups

method_avg_median = [0.0 for _ in methods]
method_mean = [0.0 for _ in methods]

joint_data = df[df['Joint_DOF'] == 'All Joints']
method_data_list = []
method_positions = []
...
ax.set_title('Median and Quartile Errors for All Subjects Degrees of Freedom for Each Method')
